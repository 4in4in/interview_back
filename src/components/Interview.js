class Interview extends HTMLElement {
  ...
  async handleStartInterview() {
    if(this.localStream === null && this.remoteStream === null) {
      this.prepare();
    }
  ...
  setRemoteView() {
    ...
    document.getElementById('remote_view1234').srcObject = remoteStream;
  ...
  clearRemoteView() {
    ...
    document.getElementById('remote_view1234').srcObject = null;
  }
  ...
  createElements() {
    ...
    document.getElementById('startInterview').onclick = () => this.handleStartInterview();
    document.getElementById('stopInterview').onclick = () => this.handleStopInterview();
